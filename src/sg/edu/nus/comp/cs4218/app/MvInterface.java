...
public interface MvInterface extends Application {
     ...
     * @throws Exception
     */
    String mvSrcFileToDestFile(Boolean isOverwrite, String srcFile, String destFile) throws AbstractApplicationException;
     ...
     * @throws Exception
     */
    String mvFilesToFolder(Boolean isOverwrite, String destFolder, String... fileName) throws AbstractApplicationException;
}