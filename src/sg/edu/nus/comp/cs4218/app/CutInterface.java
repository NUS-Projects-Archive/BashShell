...
public interface CutInterface extends Application {
     ...
     * @throws Exception
     */
    String cutFromFiles(Boolean isCharPo, Boolean isBytePo, List<int[]> ranges, String... fileName) throws AbstractApplicationException;
     ...
     * @throws Exception
     */
    String cutFromStdin(Boolean isCharPo, Boolean isBytePo, List<int[]> ranges, InputStream stdin) throws AbstractApplicationException;
}